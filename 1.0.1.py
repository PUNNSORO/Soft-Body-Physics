            ...
            if liaisons[Ai][Aj][Bi][Bj][1] != 0:
                if deformation(Bi, Bj, Ai, Aj) > 0 :
                    if deformation(Bi, Bj, Ai, Aj) >= LIST_deformation[len(LIST_deformation)-1]:
                        ...
                        print((contrainte[indice+1]-contrainte[indice])/LIST_deformation[1])
...
care=rectangle(0.07,1000,0.5,1,[1,0.2],1,[0.2,0.8],[[0,0,0,0]],[0,0],0) #longueur_precision_spaciale,raideur,dissipation_lors_des_collision,mass,dimensions,alpha,position_initial,positions_de_qlq_points,vitesse_de_G,rotat
care.simuler(10000,1/10000,600)#temps_de_la_simulation,precision_dt,scale
