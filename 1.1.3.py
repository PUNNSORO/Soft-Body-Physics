...
class rectangle:
    ...
    def simuler(self,temps_de_la_simulation,precision_dt,scale):
        ...
        def raideur(Bi, Bj, Ai, Aj):
            return young(Bi, Bj, Ai, Aj) * l / (2*(1+np.sqrt(2)))
...
care=rectangle(1/7,100,0.5,20,[1,1],1,[0.7,0.2],[[0,0,0,0]],[0,0],0)#longueur_precision_spaciale,raideur,dissipation_lors_des_collision,mass,dimensions,alpha,position_initial,positions_de_qlq_points,vitesse_de_G,rotat
